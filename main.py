...
quake = Spell("Quake", 20, 540, "black")
...
superpotion = Item("Super Potion", "potion", "Heals 1000", 1000)
...
#Instantiate People
#person = Person(hp, mp, atk, def,magic)
player1 = Person("Valos ", 3260, 132, 300, 34, player_spells, player_items)
player2 = Person("Kaios ", 4160, 188, 311, 34, player_spells, player_items)
player3 = Person("Mars  ", 3089, 174, 288, 34, player_spells, player_items)
...
while running:
    ...
    for player in players:
        ...
        if index == 0:
            ...
            magic_dmg = spell.genarate_spell_damage()
